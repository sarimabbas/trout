...
> **RIP** — These instructions document the original app. The hosted webhook service is no longer running.
...
![CURL response](/docs/get-started/2-curl-response.png)
...
![Copy CLI command](/docs/get-started/3-source-id.png)

![CLI listen](/docs/get-started/4-cli-install.png)
...
![RequestBin](/docs/get-started/6-requestbin.png)
...
![Create new sink](/docs/get-started/7-create-sink.png)
...
![Edit sink](/docs/get-started/8-edit-sink.png)

![Set url](/docs/get-started/9-set-url.png)
...
![Connect source and sink](/docs/get-started/10-connect.png)
