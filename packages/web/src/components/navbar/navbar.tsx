...
export const Navbar = () => {
  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-8 p-8 bg-white border-4 border-blue-200 shadow-md shadow-blue-50 dark:bg-zinc-900 rounded-xl">
      {/* left */}
